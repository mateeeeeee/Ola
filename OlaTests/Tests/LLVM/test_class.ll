...
define void @"S::Init__I__I"(ptr %this, i64 %x, i64 %y) {
entry:
...
define void @"S::SetX__I"(ptr %this, i64 %x) {
entry:
  %0 = alloca i64, align 8
  store i64 %x, ptr %0, align 4
...
define void @"S::SetY__I"(ptr %this, i64 %y) {
entry:
  %0 = alloca i64, align 8
...
define internal void @StructByValue__S(%S %s) {
entry:
  %0 = alloca %S, align 8
  store %S %s, ptr %0, align 4
  call void @"S::SetX__I"(ptr %0, i64 100)
  call void @"S::SetY__I"(ptr %0, i64 100)
...
define internal void @StructByRef__Sref(ptr %s) {
entry:
  %0 = alloca ptr, align 8
  store ptr %s, ptr %0, align 8
  %1 = load ptr, ptr %0, align 8
  call void @"S::SetX__I"(ptr %1, i64 1000)
  call void @"S::SetY__I"(ptr %1, i64 1000)
...
entry:
  ...
  call void @"S::Init__I__I"(ptr %1, i64 10, i64 10)
  %4 = load %S, ptr %1, align 4
  call void @StructByValue__S(%S %4)
  ...
  call void @"S::SetX__I"(ptr %1, i64 25)
  call void @"S::SetY__I"(ptr %1, i64 25)
  ...
  call void @StructByRef__Sref(ptr %1)
  ...
  call void @"S::SetX__I"(ptr %25, i64 0)
