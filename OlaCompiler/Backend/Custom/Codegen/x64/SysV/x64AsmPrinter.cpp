...
namespace ola
{
	...
	void SysV_x64AsmPrinter::PrintModule(MachineModule const& M)
	{
	...
	std::string SysV_x64AsmPrinter::GetFPConstantPoolEntry(Int64 value)
	{
	...
	std::string SysV_x64AsmPrinter::GetIntConstantPoolEntry(Int64 value)
	{
