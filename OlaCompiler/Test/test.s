...
# %bb.1:                                # %exit
	...
	.type	32;
	.endef
	.p2align	4, 0x90                         # -- Begin function PassBase
PassBase:                               # @PassBase
.seh_proc PassBase
# %bb.0:                                # %entry
	sub	rsp, 40
...
# %bb.1:                                # %exit
	...
	.type	32;
	.endef
	.p2align	4, 0x90                         # -- Begin function PassBaseRef
PassBaseRef:                            # @PassBaseRef
.seh_proc PassBaseRef
# %bb.0:                                # %entry
	sub	rsp, 56
	.seh_stackalloc 56
	.seh_endprologue
...
# %bb.1:                                # %exit
	...
	.type	32;
	.endef
	.p2align	4, 0x90                         # -- Begin function PassDerived
PassDerived:                            # @PassDerived
.seh_proc PassDerived
# %bb.0:                                # %entry
	sub	rsp, 56
	.seh_stackalloc 56
	.seh_endprologue
...
# %bb.1:                                # %exit
	...
	.type	32;
	.endef
	.p2align	4, 0x90                         # -- Begin function PassDerivedRef
PassDerivedRef:                         # @PassDerivedRef
.seh_proc PassDerivedRef
# %bb.0:                                # %entry
	sub	rsp, 56
	.seh_stackalloc 56
	.seh_endprologue
...
# %bb.1:                                # %exit
	...
	.addrsig_sym PassBase
	.addrsig_sym PassBaseRef
	.addrsig_sym PassDerived
	.addrsig_sym PassDerivedRef
