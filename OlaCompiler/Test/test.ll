...
entry:
  ...
  %2 = call i64 @"Derived::GetY"(ptr %this)
  %3 = add i64 %1, %2
  %4 = call i64 @"Base::GetX"(ptr %this)
  %5 = add i64 %3, %4
...
define internal void @PassBase(%Base %b) {
entry:
...
define internal void @PassBaseRef(ptr %b) {
entry:
...
define internal void @PassDerived(%Derived %d) {
entry:
...
define internal void @PassDerivedRef(ptr %d) {
entry:
  %0 = alloca ptr, align 8
...
entry:
  ...
  call void @PassBase(%Base %10)
  %11 = load %Base, ptr %5, align 4
  call void @PassBaseRef(ptr %5)
  ...
  call void @PassBase(%Base %27)
  %28 = load %Base, ptr %22, align 4
  call void @PassBaseRef(ptr %22)
  ...
  call void @PassDerived(%Derived %38)
  %39 = load %Derived, ptr %31, align 4
  call void @PassDerivedRef(ptr %31)
  br label %exit
...
entry:
  ...
  call void @PassBase(%Base %36)
  %37 = load %Base, ptr %31, align 4
  call void @PassBaseRef(ptr %31)
  br label %exit
