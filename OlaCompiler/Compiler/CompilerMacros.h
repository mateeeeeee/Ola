...
#ifdef DEBUG
#define OLA_EXE_PATH OLA_BINARY_PATH "Debug/Ola.exe"
...
#else
#define OLA_EXE_PATH OLA_BINARY_PATH "Release/Ola.exe"
...
#if DEBUG
#define OLA_STATIC_LIB_PATH OLA_BINARY_PATH "Debug/olalib.lib"
#else
#define OLA_STATIC_LIB_PATH OLA_BINARY_PATH "Release/olalib.lib"
#endif
