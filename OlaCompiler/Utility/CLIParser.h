...
namespace ola
{
	...
	public:
		...
		{
			OLA_ASSERT_MSG(cli_arg_map.contains(prefix), "Did you forgot to add this Arg to CLIParser?");
	...
	public:
		CLIParser() {}
		OLA_MAYBE_UNUSED Uint32 AddArg(Bool has_value, std::convertible_to<std::string> auto... prefixes)
		{
