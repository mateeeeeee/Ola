...
namespace wave
{
	...
	public:
		...
		virtual void Visit(BreakStmt const&, uint32 depth) override;
		virtual void Visit(ContinueStmt const&, uint32 depth) override;
		...
		virtual void Visit(ConstantFloat const&, uint32 depth) override;
