...
int main()
{
	...
	Char const* argv[] = { "-i", "test", "--O0","--nollvm", "--cfg", "--domtree", "--domfrontier", "--emit-asm","--emit-ir", "--directory", OLA_PLAYGROUND_PATH"Test"};
	//Char const* argv[] = { "-i", "test", "--O0", "--cfg", "--domtree", "--domfrontier", "--emit-asm","--emit-ir", "--directory", OLA_PLAYGROUND_PATH"Test" };
